...
from src.components.FP_transformation import DataTransformation
from src.components.FP_model_trainer import ModelTrainer
from src.components.FP_transformation import DataTransformationConfig
from src.components.FP_model_trainer import ModelTrainerConfig



@dataclass
class DataIngestionConfig:
    train_path:str = os.path.join("artifacts","fp_train.csv")
    test_path:str = os.path.join("artifacts","fp_test.csv")
    raw_path:str = os.path.join("artifacts","fp_data.csv")
